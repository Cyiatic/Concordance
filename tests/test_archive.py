...
class ArchiveTests(unittest.TestCase):
    ...
    def test_build_copies_viewer_data_and_assets(self) -> None:
        with tempfile.TemporaryDirectory() as temporary:
            ...
            self.assertIn("sidebar-controls", html)
            self.assertIn("mobile-controls", html)
            ...
            self.assertIn("sidebar-author-filter", html)
            self.assertIn("sidebar-timezone-mode", html)
            ...
            self.assertEqual(html.count('data-action="print"'), 2)
            ...
            self.assertEqual(
                ...
                {"archive.json", "app.js", "index.html", "assets/concordance-mark.png", "assets/avatars/eli.svg", "assets/avatars/mara.svg", "assets/attachments/note.svg"},
            )
